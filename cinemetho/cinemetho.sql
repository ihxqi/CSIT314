...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2023 at 11:57 AM
...
(7, 'Combo D', 'test', 1, 2, 'Active'),
(8, 'test123', 'test123', 1, 2, 'Active');
...
--
ALTER TABLE `fnb`
  MODIFY `comboID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
