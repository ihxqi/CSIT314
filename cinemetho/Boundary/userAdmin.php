        ...
        <div class="white-box">
            ...
            <table id="profileTable" class="CMtable" style="width:100%">
                <tr>
                    ...
                    <th>Status</th>
                    <th>Action</th>
                </tr> <?php foreach ($userProfiles as $userprofile) { ?> <tr>
                    <td  id="profileTable" class="CMtable"> <?php echo is_array($userprofile) ? $userprofile['upName'] : $userprofile; ?> </td>
                    <td  id="profileTable" class="CMtable"> <?php echo is_array($userprofile) ? $userprofile['profile_status'] : $userprofile; ?> </td>
                    <td>
                        <a href="updateUserProfile.php?userProfile_ID=
																			<?php echo $userprofile['userProfile_ID']; ?>&upName=
																			<?php echo $userprofile['upName']; ?>">Update </a> | <a href="suspendUserProfile.php?userProfile_ID=
																			<?php echo $userprofile['userProfile_ID']; ?>" onClick="return confirm('Are you sure you want to suspend?')">Suspend </a> | <a href="activateUserProfile.php?userProfile_ID=
																			<?php echo $userprofile['userProfile_ID']; ?>" onClick="return confirm('Are you sure you want to activate?')">Activate </a>
                    </td>
                </tr> <?php } ?>
            </table>
            <br>
