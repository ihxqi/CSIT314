			...
			<table id="movieTable" class="CMtable">
				...
				<?php 
                        foreach ($userAccount as $userAccount) { // Need change 
							...
							echo "<td>" . $userAccount['movie_id'] . "</td>";
                            echo "<td>" . $userAccount['movie_title'] . "</td>";
                            echo "<td>" . $userAccount['movie_synopsis'] . "</td>";
                            echo "<td>" . $userAccount['movie_genre'] . "</td>";
                            echo "<td>" . $userAccount['movie_language'] . "</td>";
							echo "<td>" . $userAccount['movie_duration'] . "</td>";
							echo "<td>" . $userAccount['mpa_rating'] . "</td>";
							echo "<td>" . $userAccount['movie_image'] . "</td>";
							echo "<td>" . $userAccount['movie_cast'] . "</td>";
							echo "<td>" . $userAccount['movie_director'] . "</td>";
							echo "<td>" . $userAccount['movie_status'] . "</td>";
                            echo "<td><a href=\"updateMovies.php?movie_id={$userAccount['movie_id']}\" class='button'>Update</a> | <a href=\"suspendMovies.php?user_id={$userAccount['movie_id']}\" onClick=\"return confirm('Are you sure you want to suspend?')\" class='button'>Suspend</a>| <a href=\"activateMovies.php?user_id={$userAccount['movie_id']}\" onClick=\"return confirm('Are you sure you want to activate?')\" class='button'>Activate</a></td>";
                            echo "</tr>";
                        }
                    ?>
				</tr>		
