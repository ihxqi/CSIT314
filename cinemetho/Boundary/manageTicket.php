<?php
include_once("../Controller/getUserAccountCtl.php"); // need to change no such file yet
include_once("../Controller/addUserAccountCtl.php"); // need to change no such file yet
include_once("../Controller/updateUserAccountCtl.php"); // need to change no such file yet
include_once("../Controller/suspendUserAccountCtl.php"); // need to change no such file yet


$ticketClt = new getTicket();
$ticket = $ticketClt->getTicket();
	...
	<body>
		<div class="white-box">
			...
			<table id="ticketTable" class="CMtable">
				...
				include_once("../Controller/getFnBCtl.php");<!-- need to change -->
        
                include_once("../Controller/suspendFnBCtl.php");<!-- need to change -->

                $FnBCtl = new getFnBCtl(); <!-- need to change -->
                $fnbCombos = $FnBCtl->getFnB() <!-- need to change -->

                        foreach ($ticket as $ticket) { 
                            echo "<tr class='border-bottom'>";
							echo "<td>" . $ticket['Ticket_cust_profile'] . "</td>";
                            echo "<td>" . $ticket['TicketPrice'] . "</td>";
                            echo "<td><a href=\"updateTicket.php?Ticket_cust_profile={$ticket['Ticket_cust_profile']}\" class='button'>Update</a> | <a href=\"suspendTicket.php?Ticket_cust_profile={$Ticket['Ticket_cust_profile']}\" onClick=\"return confirm('Are you sure you want to suspend?')\" class='button'>Suspend</a>| <a href=\"activateTicket.php?Ticket_cust_profile={$Ticket['Ticket_cust_profile']}\" onClick=\"return confirm('Are you sure you want to activate?')\" class='button'>Activate</a></td>";
                            echo "</tr>";
                        }
