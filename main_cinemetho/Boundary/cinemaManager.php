        ...
        <section>
            <div class="container2">
                ...
                ?>
                    <div class="box">
                        <div class="imgBx">
                            <a href="cinemaManagerDesc.php?movie_id=<?php echo $movie['movie_id']; ?>">
                                <img src="<?php echo $movie['movieImage']; ?>">
                            </a>
                        </div>
                        <div class="layer layer1"></div>

                        <a href="cinemaManagerDesc.php?movie_id=<?php echo $movie['movie_id']; ?>" style="text-decoration:none">
                            <div class="contentBx">
                                <div>
